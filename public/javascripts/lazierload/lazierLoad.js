  ...
  */
	...
	// lazierLoad default options
		var lazierLoadDefaultOptions = {
			...
			replaceImage	: "/javascripts/lazierload/blank.gif",					// Placeholder image to show instead of the image (best leave unchanged to this blank.gif!)
			loadingImage	: "/javascripts/lazierload/spinner.gif",				// Loading indicator
  ...
  */
	 ...
	 */
		...
		JS_BRAMUS.lazierLoadImage.prototype 	= {
          ...
          if(pie.isIE()){
            Event.observe(document.body, 'scroll', this.lazyScroller.bind(this), false);
          }else{
